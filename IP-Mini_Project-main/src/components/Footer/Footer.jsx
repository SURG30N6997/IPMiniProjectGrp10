  ...
  return (
    ...
    >
      <StackColumn>
        ...
        />
        <FooterLink 
        text={'info@vaultx.com'} 
        />
      </StackColumn>
      
      <StackColumn>
        <FooterTitle text={'our services'} />
        <FooterLink text={'Track Expense'} />
        <FooterLink text={'Analize Expense'} />
        <FooterLink text={'Achieve Goals'} />
        <FooterLink text={'Get Ai Suggestions'} />
      </StackColumn>
      <StackColumn>
